...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-sm shadow-primary/20 hover:bg-primary/90 active:bg-primary/80",
        ...
        outline: "border border-input bg-card shadow-sm hover:border-primary/30 hover:bg-accent hover:text-accent-foreground active:bg-accent/80",
      ...
      size: {
        default: "h-10 min-h-[42px] px-4 py-2",
        sm: "h-9 min-h-[36px] rounded-md px-3",
        lg: "h-11 min-h-[48px] rounded-md px-8",
        icon: "h-10 w-10 min-h-[42px] min-w-[42px]",
      },
    },
    defaultVariants: {
      variant: "default",
